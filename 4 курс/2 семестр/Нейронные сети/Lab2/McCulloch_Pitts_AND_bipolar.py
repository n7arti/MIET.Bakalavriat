...
# Реализация функции "И" (англ. "AND") с использованием нейрона Мак-Каллока-Питтса с биполярными входами и выходами
...
print('Нейрон МакКаллока-Питса для функции "И" (англ. "AND") с биполярными входами и выходами')
print('Веса нейрона')
print(w1)
print(w2)
